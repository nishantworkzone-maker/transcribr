/**
 * Transcribr Theme System
 * - Set once (from homepage toggle)
 * - Persists via localStorage
 * - Every page auto-applies on load (no FOUC)
 */
(function () {
  const KEY = 'transcribr_theme';
  ...
  // Apply immediately to prevent flash on every page
  const saved = localStorage.getItem(KEY) || 'dark';
  applyTheme(saved);

  // Expose globals for homepage toggle button only
